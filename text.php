...
$text = [
    ...
    'main' => [
       ...
       'h1'=>[ 
        ...
        'halal'=> [
            'ru' => 'Одобрено духовным<br>управлением мусульман <abbr title="Республика Татарстан">РТ</abbr>',
            'kz'=>'Татарстан Республикасының Мұсылмандар Діни басқармасымен мақұлданды',
            'en'=>'Approved by the Spiritual Board of Muslims of the Republic of Tatarstan'
        ],
        'tink'=> [
            'ru' => 'В&nbsp;партнерстве<br>с&nbsp;Тинькофф Инвестиции',
            'kz'=>'“Тинькофф Инвестициялар” -  ымен бірлесе отыра',
            'en'=>'In partnership with Tinkoff Investments'
        ]
    ],
    'information' => [
            'h2'=>[
    ...
    'analysis-company' => [
        ...
        'team' =>[
            ...
            'o6'=>[
                'ru'=>'Преподаватель в ТОО "Центр анализа и развития межконфессиональных отношений" (ЦАРМО) при Управлении по делам религии Павлодарской области (Казахстан), Директор Российского Центра Исламской Экономики и Финансов (РЦИЭФ) при Российском исламском институте (РИИ)',
        ...
        'contacts'=>[
            ...
            'addr'=>[
                'ru'=>'<b>Иннополис</b>, Университетская 7, офис 503<br><b>Республика Казахстан</b>, г. Астана, Международный Финансовый Центр Астана (МФЦА)',
